...
// ============================================================
//
// Scope closure Z v3.0.0-rc.2 (§22.37 decision 8 + §6.162 deviation).
//   - Versione PharmaTimer 3.0.0-rc.2 (synced con package.json post-bump P2.C)
  ...
  return (
    ...
    >
      <p className="text-xs" style={{ color: t.textPrimary, opacity: 0.6 }}>
        PharmaTimer 3.0.0-rc.2 · <em className="italic">by timegates</em> ·{' '}
        <a
          href={guideUrl}
          target="_blank"
          rel="noopener noreferrer"
